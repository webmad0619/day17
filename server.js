...
const fs = require("fs")
fs.writeFile(
    "/Users/danielgarcia/Documents/sources/webmad0619/day17/cleanData.json",
    JSON.stringify(fixedMovies),
    function (err, data) {
        console.log("file with clean json has been written out")
    })

// old way but still valid, I do prefer the first one though
// let fixedMoviesWay2 = movies.map(movie => {
